...
const experiences = [
  ...
  },
  {
    ...
    company: "JustDoc",
    location: "India",
    period: "Jul 2018 - Sep 2018 (3 months)",
    type: "Full-time",
    description:
      "Managed daily operations, coordinating with doctors and resolving operational challenges. Organized and input information into the system portal for efficient data management. Proposed and executed strategies for automating admin functionalities and streamlining processes.",
    responsibilities: [
      "Manage daily operations, coordinating with doctors & resolving challenges",
      "Organize & input information into the system portal for efficient data management",
      "Propose & execute strategies for automating admin functionalities",
      "Streamline operational processes for improved efficiency",
      "Coordinate between medical staff and technical teams",
    ],
    technologies: ["Operations Management", "Data Management", "Process Automation", "Healthcare Systems"],
    achievements: [
      "Successfully coordinated daily operations with medical professionals",
      "Improved data management efficiency through systematic organization",
      "Implemented automation strategies for administrative tasks",
    ],
  },
]
